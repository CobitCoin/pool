# Cobitcoin-pool based on cryptonote-forknote-pool




High performance Node.js (with native C addons) mining pool for Cobitcoin.
...
#### Requirements
* Coin daemon(s) on https://github.com/CobitCoin/cobitcoin
* simplewallet https://github.com/CobitCoin/cobitcoin 
```
